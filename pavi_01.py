...
class vivien:
    ...
    def pos_table(self,ta,gg):
        "gi =[10,15] gg=gril_game"
        a,b                                     =   ta
        c,d                                     =   gg["ajt"]
        e                                       =   gg["taile"]
        return  [(a+c)*e,(b+d)*e],[a+c,b+d]
    ...
    def draw_lib(self,sur_r,data,ajt):
        ""
        ...
        for i in data:
            ...
            data[i]["ajt"]                      =   ajt
            sca,scb                             =   data[i]['szc']            
            rect                                =   self.pos_table(i,data[i])[0]
    ...
    def make_pixel(self,but_app,pad,g_g):
        ...
        if g_g['on']                                ==1:
            ...
            for i in gg:
                if type(())==type(i):
                    ...
                    pygame.draw.rect(sur_r,g_g[i]['cl'],posa+[g_g['taile']]*2,g_g[i]["w"])
        g_g['taile'] =t_old                    
